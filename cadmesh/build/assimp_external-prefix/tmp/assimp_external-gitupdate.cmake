...
execute_process(
  COMMAND "/usr/bin/git" show-ref v4.0.1
  WORKING_DIRECTORY "/media/anon/Data/uob/iac/scintillators/cadmesh/CADMesh/external/assimp"
...
if("${show_ref_output}" MATCHES "refs/remotes/v4.0.1")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v4.0.1")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v4.0.1
  WORKING_DIRECTORY "/media/anon/Data/uob/iac/scintillators/cadmesh/CADMesh/external/assimp"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/media/anon/Data/uob/iac/scintillators/cadmesh/CADMesh/external/assimp/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/media/anon/Data/uob/iac/scintillators/cadmesh/CADMesh/external/assimp/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
